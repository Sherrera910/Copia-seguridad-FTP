...
# Pedir al usuario que introduzca los valores de ftp_server, ftp_username y ftp_password
ftp_server = input("Introduce el servidor FTP: ")
ftp_username = input("Introduce el nombre de usuario: ")
ftp_password = input("Introduce la contraseña: ")

# directorio local a copiar
local_dir = input("Introduce el directorio a copiar: ")
...
def send_email(to_email, subject, content_html, content_text):
        gmail_user = input("Introduce tu correo de Gmail: ")
        gmail_password = input("Introduce tu contraseña de Gmail: ")
